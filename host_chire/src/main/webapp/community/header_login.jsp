			...
			<div style="width : 1280px; margin: 0 auto;">
				<div class="topheader">
					<div class="top">
						...
						<div class="login_items login_items2">
							...
							<div class="login_item_index2">
								<div class="login_item_text2"><a href="../sns/myPageWrite.jsp?cust_id=<%=id%>">마이페이지</div>
							</div>
							<div class="login_item_index2">
								<div class="login_item_text2"><a href="../sns/snsFollowLoginAction.sns?cust_id=<%=id%>">팔로우</div>
							</div>
							<div class="login_item_index2">
					...
					<div class="items items2">
						<a class="item_index" href="view_write.jsp">
						...
						<a class="item_index" href="../sns/snsWrite.jsp">
							<div style="width:50px; height: 50px;">
							<!-- 이미지영역 -->
								<svg version="1.1" id="Uploaded to svgrepo.com" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="50px" height="50px" viewBox="0 0 32 32" xml:space="preserve">
									<g>
