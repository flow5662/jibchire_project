...
<style>
	...
	* { margin : 0 ; padding : 0 ; } 
	...
	.items{width:400px;height: 320px;margin-top: 75px; margin-right: -390px;}
	.items2{
		position: relative;
		background-color: white;
...
<!-- 							</a> -->
<!-- 						</div> -->
						<div class="login"><li><a href="login.jsp">로그인</a></li></div>
						<div class="join"><li><a href ="join.jsp">회원가입</a></li></div>
	...
	<div class="line"></div>
		...
		<nav>
			<div id="cumu">	
				...
				<div class="index2"><li><a href="publicapiinfo.sns">대여소 찾기</a></li></div>
			</div>
