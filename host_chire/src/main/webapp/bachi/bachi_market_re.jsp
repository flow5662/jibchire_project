...
<input type="text" name="market_title" placeholder="제목을 입력하세요." class="css-market-title-style css-title" required="required">
</div>
...
<div class="file-css">
 <input type="file" id="file-input" name="filename" required="required">
